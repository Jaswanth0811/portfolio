    ...
    <Section id="hobbies">
      <div className="space-y-12">
        ...
        <div className="relative inline-flex flex-col w-full max-w-4xl rounded-[24px] cursor-pointer group transition-all duration-500 hover:-translate-y-2">
          ...
          {/* INNER CONTENT */}
          <div className="relative z-10 m-[1.5px] flex flex-col justify-center h-[calc(100%-3px)] w-[calc(100%-3px)] bg-background rounded-[22.5px] p-8 md:p-12 overflow-hidden shadow-xl">
